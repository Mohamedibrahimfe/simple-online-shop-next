...
const About1 = () => {
  return (
    <div className="2xl:container 2xl:mx-auto lg:py-8 lg:px-32 md:py-12 md:px-6 py-16 px-4 shadow-lg shadow-slate-200">
      ...
      <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
        ...
        <div className="w-full lg:w-8/12 lg:pt-8">
          <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:mt-10 lg:gap-4 shadow-lg rounded-md ">
